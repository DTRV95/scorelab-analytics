  ...
  return (
    <div className={cn("relative overflow-hidden rounded-[inherit]", className)}>
      <motion.div
        key={sweepKey}
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-[-35%] z-20 w-1/3 -skew-x-12 bg-primary/10 blur-sm"
...
export function PitchMarkings({
  ...
  return (
    ...
    >
      <div className="absolute inset-x-8 bottom-8 h-px bg-primary/10" />
      ...
      <div className="absolute left-[12%] top-0 h-full w-px bg-primary/10" />
      <div className="absolute right-[12%] top-0 h-full w-px bg-primary/10" />
    </div>
  );
}
