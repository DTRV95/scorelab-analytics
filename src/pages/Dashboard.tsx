    ...
    <AppLayout>
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
          {/* Top Value Bet Today */}
          <div className="lg:col-span-2 rounded-xl bg-card ring-surface p-6 card-shadow">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-lg bg-white/[0.03] ring-1 ring-white/5 p-3">
                    ...
                    <p className="text-xl font-bold font-mono-data text-foreground">{topValue.modelProb}%</p>
                  </div>
                  <div className="rounded-lg bg-white/[0.03] ring-1 ring-white/5 p-3">
                    <p className="text-xs text-muted-foreground">Implied Prob.</p>
                    <p className="text-xl font-bold font-mono-data text-muted-foreground">{topValue.impliedProb}%</p>
                  </div>
                  <div className="rounded-lg bg-white/[0.03] ring-1 ring-white/5 p-3">
                    <p className="text-xs text-muted-foreground">Value Edge</p>
                    <p className="text-xl font-bold font-mono-data text-primary">+{topValue.edge}%</p>
                  </div>
                  <div className="rounded-lg bg-white/[0.03] ring-1 ring-white/5 p-3">
                    <p className="text-xs text-muted-foreground">Kelly Stake</p>
                    <p className="text-xl font-bold font-mono-data text-foreground">{topValue.kelly}%</p>
                  </div>
                </div>
              </div>
              <div className="flex-1">
          ...
          <div className="rounded-xl bg-card ring-surface p-6 card-shadow">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={trendData}>
                ...
                <YAxis hide />
                <Tooltip
                  contentStyle={{ backgroundColor: "hsl(222, 47%, 7%)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, fontSize: 12 }}
